...
public class PBSDto {
    ...
    public PBSDto(Integer id, String book, Integer chapter, Integer startVerse, Integer endVerse, String content, String userName, String userId, Date createAt,  String showData) {
        this.id = id;
        this.book = book;
